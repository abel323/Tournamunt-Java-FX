    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()==btnSearch){
            if(cboFilter.getSelectedItem()=="*"){
                try{
                    connection();
                    String sql = "SELECT * FROM player_detail";
                ...
                try{
                    connection();
                    String sql = "SELECT * FROM player_detail WHERE FName='" + txtSearchTerm.getText()+"'";
                    Statement stmt = conn.createStatement();
                    ResultSet result = stmt.executeQuery(sql);
                    int i=0;
                    while(result.next()){
                ...
                try{
                    connection();
                    String sql = "SELECT * FROM player_detail WHERE MName='"+txtSearchTerm.getText()+"'";
                    Statement stmt = conn.createStatement();
                    ResultSet result = stmt.executeQuery(sql);
                    int i=0;
                    while(result.next()){
                ...
                try{
                    connection();
                    String sql = "SELECT * FROM player_detail WHERE LMame='" + txtSearchTerm.getText()+"'";
                    Statement stmt = conn.createStatement();
                    ResultSet result = stmt.executeQuery(sql);
                    int i=0;
                    while(result.next()){
                ...
                try{
                    connection();
                    String sql = "SELECT * FROM player_detail WHERE DOB='" +txtSearchTerm.getText()+"'";
                    Statement stmt = conn.createStatement();
                    ResultSet result = stmt.executeQuery(sql);
                    int i=0;
                    while(result.next()){
                ...
                try{
                    connection();
                    String sql = "SELECT * FROM player_detail WHERE Team_Name='" + txtSearchTerm.getText()+"'";
                    Statement stmt = conn.createStatement();
                    ResultSet result = stmt.executeQuery(sql);
                    int i=0;
                    while(result.next()){
